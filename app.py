...
client = MongoClient('mongodb+srv://s:syarifH1@cluster0.am45tnd.mongodb.net/?retryWrites=true&w=majority')
...
def detail(keyword):
    api_key = '9e32c319-40a5-4d03-a005-07a970053aff'
